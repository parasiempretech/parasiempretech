...
const EXCELLENCE_STACK: TechStackItem[] = [
  ...
  { name: "Vue.js", icon: SiVuedotjs, color: "#42B883" }, // ✅ CORREGIDO
...
// --- Variantes Framer Motion corregidas ---
...
export default function TechCloud({
  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-24 overflow-hidden">
      ...
      {/* Fondo con halo */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(16,185,129,0.06),_transparent_70%)] blur-2xl pointer-events-none" />
    </section>
  );
}
