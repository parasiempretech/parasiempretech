...
// CORRECCIÓN: Importamos el tipo 'Variants' para decirle a TypeScript que estas estructuras son válidas.
...
// --- Variantes Framer Motion corregidas (SOLUCIÓN: Añadimos : Variants) ---
...
export default function TechCloud({
  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-24 overflow-hidden">
      ...
      {/* Grid de tecnologías */}
      <motion.div
        className="relative z-10 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-x-6 gap-y-10 px-4 max-w-7xl"
