// src/components/carousel/DraggableCarousel.tsx
...
export default function DraggableCarousel({
  ...
  const onMouseDown = (e: React.MouseEvent) => {
    ...
    setIsDragging(true);
    // Posición inicial del click y del scroll
  ...
  const onMouseMove = (e: React.MouseEvent) => {
    ...
    const walk = (x - startX) * 2; // El multiplicador '2' aumenta la velocidad de arrastre
