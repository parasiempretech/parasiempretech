...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { href: "/faq", label: "Preguntas frecuentes" }, // ✅ Nueva página separada
  ];
            ...
            return (
              <Link
                ...
                className={`relative rounded-md px-3 py-2 text-sm font-medium transition-all duration-200
                  ${
                    isActive
                      ? "text-white after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-full after:bg-gradient-to-r after:from-emerald-400 after:to-sky-400"
                      : "text-gray-300 hover:text-white hover:after:absolute hover:after:left-0 hover:after:bottom-0 hover:after:h-[2px] hover:after:w-full hover:after:bg-gradient-to-r hover:after:from-emerald-400 hover:after:to-sky-400"
                  }`}
              >
                {link.label}
              </Link>
