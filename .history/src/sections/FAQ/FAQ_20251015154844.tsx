...
import { useModal } from "@/context/ModalContext"; // ✅ Import correcto del contexto

// --- Componente Principal ---
export default function FAQ() {
  const [openIndex, setOpenIndex] = useState<number | null>(null);
  const { openModal } = useModal(); // ✅ Nombre correcto del método (no "open")
  ...
  return (
    ...
    >
      ...
      >
        ¿Tenés otra pregunta?{" "}
        <button
          onClick={openModal} // ✅ Usa el método correcto del contexto
          className="text-[#39ff14] font-medium underline underline-offset-4 hover:text-[#6EE7F9] transition"
        >
