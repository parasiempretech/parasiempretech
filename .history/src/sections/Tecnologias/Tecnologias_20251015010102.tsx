...
export default function Tecnologias() {
  ...
  return (
    ...
    >
      ...
      {/* Bloques explicativos: TRUCO DE DISEÑO ASIMÉTRICO y ALTURA UNIFICADA */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-8 relative z-10">
        {TECH_GROUPS.map((group, i) => {
          return (
            <motion.div
              key={group.title}
              // Aseguramos que el contenedor de la tarjeta tome la altura total de su celda
            ...
            >
              ...
              <div className="relative h-full flex flex-col justify-between">
                ...
                {/* 2. PALABRA CLAVE GRANDE (BENEFICIO VISUAL) - TAMAÑO AJUSTADO PARA LEGIBILIDAD */}
                <h4
