...
import { motion, useMotionTemplate, useMotionValue } from "framer-motion"; // Importación de useMotionValue
...
// --- Contenido de la Sección (Data - Se mantiene igual) ---
const TECH_GROUPS: TechGroup[] = [
  // ... (tu array de datos TECH_GROUPS) ...
  {
        ...
        {TECH_GROUPS.map((group, i) => {
          ...
          return (
            <motion.div
              ...
              onMouseMove={handleMouseMove} // 2. Truco: Captura de movimiento
            >
              ...
              <motion.div
                ...
                style={{
                  x: mouseX,
                  y: mouseY,
                  scale: 1.05, // Escalamos un poco para que se vea el movimiento
                }}
              ></motion.div>
              ...
              <div className="relative h-full flex flex-col justify-between">
                ...
                <div
                  ...
                  aria-label={`Tecnologías clave para ${group.title}`} // 3. Truco: Mejora de A11Y
                >
