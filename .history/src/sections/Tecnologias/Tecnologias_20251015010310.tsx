...
export default function Tecnologias() {
  ...
  // --- Renderizado de una sola tarjeta (Función auxiliar) ---
  const renderCard = (group: TechGroup, i: number, isDouble: boolean) => {
    return (
      <motion.div
        key={group.title}
        // h-full asegura que ocupe la altura de la celda.
      ...
      >
        ...
        <div className="relative h-full flex flex-col justify-between">
          ...
          <h4
            className={`font-extrabold text-4xl lg:text-5xl text-white/5 text-center mt-auto mb-4
                          ${
                            isDouble ? "lg:text-7xl" : ""
  ...
  return (
    ...
    >
      ...
      {/* Bloques explicativos: ESTRUCTURA PARA GARANTIZAR ALTURA SIMÉTRICA */}
      <div className="relative z-10 space-y-8">
        {/* FILA 1: Asimétrica (2 Columnas + 1 Columna) */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch">
          {/* Tarjeta 1 (Doble Ancho) */}
          {renderCard(TECH_GROUPS[0], 0, true)}

          {/* Contenedor para Tarjetas 2 y 3 (Se apilan en MD, quedan lado a lado en LG) */}
        ...
        {/* FILA 2: Simétrica (3 Columnas Iguales) */}
