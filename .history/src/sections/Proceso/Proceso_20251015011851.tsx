...
function PillCard({
  ...
  return (
    // Aplica el color único definido en la data (Ej: border-emerald-500/25)
    <div
...
export default function Proceso() {
  ...
  // Usaremos esta variante limpia para la cabecera
  const headerAppear = {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Link
            // HREF APUNTA A LA RUTA INTERNA DEL FORMULARIO
            href="/contacto"
