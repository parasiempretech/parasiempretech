        ...
        >
          <div>
            ...
            <input
              ...
              required
              placeholder="Ej: Álvaro Ruggeri"
              className="w-full px-4 py-3 rounded-lg bg-black/30 border border-white/20 text-white/90 placeholder-white/40 focus:border-emerald-400 focus:ring focus:ring-emerald-400/30 transition duration-200"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              required
              placeholder="Ej: quiero una web para mi negocio de autos, con turnos online..."
              className="w-full px-4 py-3 rounded-lg bg-black/30 border border-white/20 text-white/90 placeholder-white/40 focus:border-emerald-400 focus:ring focus:ring-emerald-400/30 transition duration-200"
            />
          </div>
          ...
          <motion.button
            type="submit"
            className="w-full px-10 py-3 text-lg font-bold rounded-lg text-white bg-emerald-500/80 hover:bg-emerald-500 transition-all duration-300 shadow-[0_0_10px_rgba(57,255,20,0.3)]"
