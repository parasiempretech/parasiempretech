...
const INDUSTRIES = [
  {
    ...
    icon: FaBalanceScale,
    color: "from-[#39ff14]/20 to-[#00bfff]/20",
    features: [
  ...
  },
  {
    ...
    icon: FaTooth,
    color: "from-[#00bfff]/20 to-[#39ff14]/20",
    features: [
  ...
  },
  {
    ...
    color: "from-[#ff00cc]/20 to-[#00bfff]/20",
    features: [
  ...
  },
  {
    ...
    icon: FaUtensils,
    color: "from-[#39ff14]/20 to-[#ff00cc]/20",
    features: [
  ...
  },
  {
    ...
    icon: FaCut,
    color: "from-[#00bfff]/20 to-[#ff00cc]/20",
    features: [
      "Turnos por barbero",
      "Catálogo de estilos",
  ...
  {
    title: "Industria",
    desc: "Monitoreo y trazabilidad de procesos en tiempo real.",
    icon: FaIndustry,
    color: "from-[#39ff14]/20 to-[#00bfff]/20",
    features: [
      "Backoffice de stock",
  ...
  // --- NUEVOS RUBROS ---
  {
    ...
    desc: "E-commerce autogestionable con catálogo y pagos integrados.",
    icon: FaStore,
    color: "from-[#00bfff]/20 to-[#ff00cc]/20",
    features: ["Carrito de compras", "Pasarelas de pago", "Panel de productos"],
  },
  {
    title: "Estética y Spa",
    desc: "Turnos, promociones y gestión de clientes en línea.",
    icon: FaSpa,
    color: "from-[#39ff14]/20 to-[#00bfff]/20",
    features: [
      "Turnos online",
  ...
  {
    title: "Desarrolladores / IT",
    desc: "Landing pages y portfolios para programadores y agencias tech.",
    icon: FaLaptopCode,
    color: "from-[#00bfff]/20 to-[#39ff14]/20",
    features: ["Portfolios modernos", "Blog técnico", "Integración con GitHub"],
  },
  {
    title: "Educación",
    desc: "Plataformas de aprendizaje y gestión académica.",
    icon: FaSchool,
    color: "from-[#ff00cc]/20 to-[#39ff14]/20",
    features: ["Aulas virtuales", "Material descargable", "Gestión de alumnos"],
  },
  {
    title: "Salud",
    desc: "Sistemas para clínicas, nutricionistas y profesionales de la salud.",
    icon: FaStethoscope,
    color: "from-[#00bfff]/20 to-[#39ff14]/20",
    features: ["Agenda médica", "Consultas online", "Panel de seguimiento"],
  },
  {
    title: "RRHH y Consultoras",
    desc: "Optimización de procesos de selección y reclutamiento.",
    icon: FaUsers,
    color: "from-[#39ff14]/20 to-[#ff00cc]/20",
    features: ["Carga de CVs", "Panel de candidatos", "Informes automáticos"],
  },
  {
    title: "Inmobiliarias",
    desc: "Sitios con catálogo visual y administración de propiedades.",
    icon: FaHouseUser,
    color: "from-[#00bfff]/20 to-[#39ff14]/20",
    features: [
      "Filtros avanzados",
  ...
  {
    title: "Música y Producción",
    desc: "Sitios interactivos para artistas, bandas y productores.",
    icon: FaMusic,
    color: "from-[#ff00cc]/20 to-[#00bfff]/20",
    features: ["Reproductor de audio", "Agenda de shows", "Galería multimedia"],
  },
  {
    title: "Automotriz",
    desc: "Sistemas para venta, detailing y gestión de talleres.",
    icon: FaCar,
    color: "from-[#39ff14]/20 to-[#00bfff]/20",
    features: [
      "Catálogo de autos",
